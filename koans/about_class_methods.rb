...
class AboutClassMethods < EdgeCase::Koan
  ...
  # In general, I prefer the 'self.' notation, as I think it reads a
  # little more clearly. If I am defining several class methods in a row,
  # I may use the shovel operator to save some typing and eliminate the
  # redundancy of the 'self.' everywhere.
